...
def try_methods():
    ...
    ####################################################################
    vivi = rg.SimpleTurtle('turtle')
    vivi.pen = rg.Pen('brown', 5)
    vivi.forward(150)
    vivi.left(90)
    vivi.forward(50)
    vivi.backward(100)
...
def try_methods_and_functions():
    ...
    #
    ####################################################################
    vava = rg.SimpleTurtle()
    vava.pen = rg.Pen('blue', 5)
    vava.backward(150)
    vava.speed = 1
    draw_many_squares(vava, 2, 100, 30)

    vava.speed = 5
    vava.pen.color = 'red'
    draw_many_squares(vava, 10, 50, 15)

    vava.speed = 100
    vava.pen.thickness = 35
    draw_many_squares(vava, 8, 300, 60)

    vava.pen = rg.Pen('black', 3)
    vava.backward(200)
    vava.draw_circle(30)
    vava.draw_square(50)
