...
#            second_window = rg.RoseWindow(200, 100)
#
...
#                attach_to, detach_from, and clone(itself)
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center, fill_color, and class
#
#     f. What does a RoseWindow RENDER method do?
#            to finally draw all the objects attached to the RoseWindow
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            at the end of a called function; because we want the window to be open until one click on it
#
...
def main():
    ...
    example3()
    siweis_window = rg.RoseWindow()
    siweis_window.close_on_mouse_click()
